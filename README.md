...
- ***Interpreting Super-Reolution CNNs for Sub-Pixel Motion Compensation in Video Coding***,
...
```bash
--Triangle=0, --Affine=0, --DMVR=0, --BIO=0, --WeightedPredP=0, --WeightedPredB=0, --CTUSize=32, --MinQTNonISlice=4 
```
